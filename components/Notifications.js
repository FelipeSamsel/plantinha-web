      ...
      {open && (
        <div onClick={() => setOpen(false)} style={{
          ...
          <div onClick={e => e.stopPropagation()} style={{
            ...
            width: '100%', maxWidth: 370, maxHeight: '80vh',
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 16px 12px', borderBottom: '0.5px solid #E2F2D4', flexShrink: 0 }}>
              ...
              <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                {unread > 0 && (
                  <button onClick={markAllRead} style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 12, color: '#3B6D11', fontFamily: 'inherit' }}>
                    marcar todas como lidas
                  </button>
                )}
                {notifications.length > 0 && (
                  <button onClick={deleteAll} style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 12, color: '#B4B2A9', fontFamily: 'inherit' }}>
                    limpar
                  </button>
                )}
