...
function LoginScreen() {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 200, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      {mode === 'login' && (
        <div style={cardStyle}>
          <button onClick={() => setMode('home')} style={{ alignSelf: 'flex-start', background: 'none', border: 'none', color: '#888780', cursor: 'pointer', fontSize: 13, marginBottom: 16, padding: 0 }}>← Voltar</button>
          ...
          <button onClick={() => setMode('register')} style={{ background: 'none', border: 'none', color: '#3B6D11', fontSize: 13, cursor: 'pointer', marginTop: 4 }}>
      ...
      {mode === 'register' && !sent && (
        <div style={cardStyle}>
          ...
          <button onClick={() => setMode('login')} style={{ background: 'none', border: 'none', color: '#3B6D11', fontSize: 13, cursor: 'pointer', marginTop: 4 }}>
            Já tem conta? Entre
          </button>
        </div>
      )}
